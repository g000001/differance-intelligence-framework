...
$\Rmw$（中道不動点コンビネータ）と $\Svoid$（空コンビネータ）のサイクルとして
世俗諦と勝義諦の往復運動が定式化される。
...
\begin{definition}[中道不動点 $\dfix$ と空コンビネータ $\Svoid$]
$\metanegation$ の四連続適用によって到達する極限状態を中道不動点 $\dfix$ と定義する。
\[
...
界論において、双方向演繹定理は $\Rmw$（世俗諦の生成）と
$\Svoid$（勝義諦の収束）のサイクルとして以下のように記述される。
\[
\bigl(\Rmw\,\metanegation \mweq \metanegation(\Rmw\,\metanegation)\bigr)
\;\leftrightarrow\;
\bigl(\metanegation^4(\Rmw\,\metanegation) \mweq \Svoid\bigr)
\]
\end{theorem}
...
$\metanegation^4(\Rmw\,\metanegation) \mweq \dfix$ を生成する。
$\dfix$ のコンビネータ表現は $\Svoid$ であるから、
$\metanegation^4(\Rmw\,\metanegation) \mweq \Svoid$ が従う。

逆方向（$\leftarrow$）：$\metanegation^4(\Rmw\,\metanegation) \mweq \Svoid$
が成立するとき、$\metanegation\,\Svoid \mweq \Rmw$ により、
$\Svoid$ に $\metanegation$ が作用すると $\Rmw$ が再生成される。
再生成された $\Rmw$ はその定義により
$\Rmw\,\metanegation \mweq \metanegation(\Rmw\,\metanegation)$
を満たす。
\end{proof}
...
右辺 $\metanegation^4(\Rmw\,\metanegation) \mweq \Svoid$
...
界論の双方向演繹定理における
\begin{align*}
\text{左辺（世俗諦）} &: \Rmw\,\metanegation \mweq \metanegation(\Rmw\,\metanegation) \\
\text{右辺（勝義諦）} &: \metanegation^4(\Rmw\,\metanegation) \mweq \Svoid
\end{align*}
は、圏論的には
\begin{align*}
...
\hline
 & \textbf{界論} & \textbf{圏論} \\
\hline
世俗諦 & $\Rmw$ による境界生成プロセス & アイレンベルク・ムーア圏 $\mathcal{C}^T$ \\
...
$\Rmw$ と $\Svoid$ のサイクルという推進力の根拠を記述しない。
...
千葉将臣.
\newblock 空数学における中道不動点コンビネータ $\mathbf{R}_{\mathrm{mw}}$ の定式化と
無明の幾何学的・証明論的実態.
\newblock \emph{空数学・界論基礎論考}, 2026.
