...
%  独自マクロ
%-------------------------------------------------
\newcommand{\dfix}{\mathfrak{0}} % 0次元不動点（空）
\newcommand{\mweq}{\mathrel{\overset{\mathrm{mw}}{=}}}
\newcommand{\meta}{\Uparrow}     % メタ観測・推論の横棒
...
$\Cat$ における射（Morphism）$f: A \to B$ は、界論において $A$ から $B$ への推論の横棒（$\meta$）を引く操作として翻訳される。ただし、この横棒は「計算の途上」で凍結されている。
$$ \mathcal{E}(f) := A \meta B \quad \left(\text{または } \frac{\susp{A}}{\susp{B}}\right) $$
\end{definition}

\begin{definition}[合成の翻訳]
$\Cat$ における射の合成 $g \circ f$ は、推論の横棒の再帰的積み重ね（メタ階層の増築）として埋め込まれる。
$$ \mathcal{E}(g \circ f) := \meta^2 (\susp{A}, \susp{B}, \susp{C}) \quad \left(\text{すなわち } \frac{\frac{\susp{A}}{\susp{B}}}{\susp{C}}\right) $$
\end{definition}
...
すなわち、本来ならば $\meta^4 X \mweq \dfix$ となるべきところを、強制的に独立した構造として維持し続ける。
\end{axiom}
