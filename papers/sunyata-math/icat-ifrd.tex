...
\begin{enumerate}
    ...
    \item \textbf{展開（Manifestation）}: $N$ に欠落していた制御構造（再帰・状態・探索など）を、メタ否定 $\metanegation$ と顕現関係 $\entails$ の連鎖として展開する。
...
$$ \susp{P_0} \entails P_1 \entails \dots \entails \metanegation^4 P_k \mweq \dfix $$
\end{definition}
