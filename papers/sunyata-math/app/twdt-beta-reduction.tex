...
これは中道不動点コンビネータ $\Rmw$ による境界生成プロセスの世俗諦的展開である。
...
「空数学における中道不動点コンビネータ $\Rmw$ の定式化\cite{Chiba2026_Rmw}」定理3.3
...
千葉将臣.
\newblock 空数学における中道不動点コンビネータ $\mathbf{R}_{mw}$ の定式化と
無明の幾何学的・証明論的実態.
\newblock \emph{空数学・界論基礎論考}, 2026.
