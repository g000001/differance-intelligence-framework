...
しかし $\Bval$ の外側である $\dfix$（絶対不動点）へのアクセスには、
...
この再起動は一方向的（$\Ymw$ による境界生成から $\Svoid$ への収束）である。
...
$\mathbf{Y}_{\mathrm{mw}}$ の定式化と無明の幾何学的・証明論的実態.
\newblock \emph{空数学・界論基礎論考}, 2026.
