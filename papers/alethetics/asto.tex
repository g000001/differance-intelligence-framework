...
\begin{note}
The confusion between Sunyata (emptiness) and Meta-Letheia (meta-latency) arises from mistaking the aletheia-letheia transition as a ``state'' rather than as a ``transition.'' Observer dependence is fundamental to logical form.
\end{note}
...
\hline
\textbf{Structure} & Sunyata & Binary & $2 \times 2$ & $2 \times 4$ & $4 \times 4$ \\
\hline
